...
namespace MT_Copiadora
{
	class MT
	{
		...
		public bool Q0()
		{
			// Caracter1/Escribe Caracter2, Derecha -> q1
			if (Resultante[Cabezal].Equals(Caracter1))
			{
				Resultante[Cabezal] = Caracter2;
				Cabezal++;
			...
			{
				// Caracter2/Escribe Caracter1, Derecha -> q2
				if (Resultante[Cabezal].Equals(Caracter2))
				{
					Resultante[Cabezal] = Caracter1;
					Cabezal++;
				...
				else
				{
					...
					// Blanco/Escribe Blanco, Derecha -> q0
					Cabezal++;
		...
		{
			if (Cabezal < CadenaSize + 2)
			{
				// Caracter1/Caracter2, Derecha -> q1
				if (Resultante[Cabezal].Equals(Caracter1))
				{
					Resultante[Cabezal] = Caracter2;
					Cabezal++;
				...
				{
					// Caracter2/Caracter1, Derecha -> q1
					if (Resultante[Cabezal].Equals(Caracter2))
					{
						Resultante[Cabezal] = Caracter1;
						Cabezal++;
